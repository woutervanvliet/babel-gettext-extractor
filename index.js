...
module.exports = function() {
  ...
  function handleExpression(nodePath, plugin) {
    ...
    if (typeof context[translate.msgid] !== 'undefined') {
      ...
      if (context[translate.msgid].comments === undefined) {
        context[translate.msgid].comments = { reference: '' };
      }
  ...
  return { visitor: {
    ...
    NewExpression(nodePath, plugin) {
      handleExpression.bind(this)(nodePath, plugin);
    },
